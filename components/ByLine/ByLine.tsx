...
export default function ByLine( {heading, altText, sizes, srcset, providerName}: {heading: string, altText: string, sizes: string, srcset: string, providerName: string} ) {
  return (
    <div>
        ...
        <span>
          <a>
            <span>
              ...
              <img alt={altText} sizes={sizes} srcSet={srcset} loading="eager" data-component="Image"/>
            </span>
            <span>
              {providerName}
            </span>
