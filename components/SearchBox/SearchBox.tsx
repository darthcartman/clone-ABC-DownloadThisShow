      ...
      <div>
        <form className={styles.autocompleteForm}>
          <div className={styles.svgAndInputWrapper}>
            ...
            <input className={styles.searchBoxInputElement} id="abc-search-input" autoComplete="off" autoCorrect="off" autoCapitalize="off" enterKeyHint="search" placeholder="Search..." type="search" role="combobox"/>
          </div>
        </form>
      </div>
    </div>
