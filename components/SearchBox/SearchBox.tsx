      ...
      <div>
        <form className={styles.autocompleteForm}>
          <div className={styles.svgAndInputWrapper}>
            ...
            <input className={styles.searchBoxInputElement} id="abc-search-input" autocomplete="off" autocorrect="off" autocapitalize="off" enterkeyhint="search" spellcheck="false" placeholder="Search..." maxlength="512" type="search" role="combobox" value=""/>
          </div>
        </form>
      </div>
    </div>
